...
<head>
    ...
    <title>@yield('title') :: Panel de Administración Deporteando</title>
        ...
        <div id="app">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark flex-has-center ">
                <div class="flex-row container">
                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#barra" aria-controls="barra" aria-expanded="false" aria-label="Boton hamburguesa">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse flex-col flex-center" id="barra">
